...
f = function(x) { cos(x) }  # true relationship between x and y
...
lines(x_grid,f(x_grid))  # plot true y values for the grid
...
n_datasets = 10000  # number of data sets to simulate, to approximate expectations over the training Y's
